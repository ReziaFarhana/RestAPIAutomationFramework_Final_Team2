...
public class Mentions {
    ...
    public static void main(String args[]) throws IOException, URISyntaxException {
        final String bearerToken = "AAAAAAAAAAAAAAAAAAAAAGJZOAEAAAAACfxpYcjTSj0bzuhfRp%2BJUISWKVQ%3DlzKCvDNy7cfytcSijTz8QfqL7IHRhPT9KNYy5GGHvGcaZB7hiy";
        if (null != bearerToken) {
            //Replace with user ID below
            String response = getTweets("1376012108211613700", bearerToken);
